 ...
 * Rango pensado para operaciones de tenant, típicamente rápidas
 * (lecturas/escrituras simples en Postgres), salvo la invitación de
 * miembros que suma un salto HTTP interno a auth-service.
 */
const BUCKETS = [0.05, 0.1, 0.2, 0.3, 0.5, 0.8, 1, 1.5, 2, 3];

/**
 * Servicio de métricas Prometheus de company-service.
