...
const MAX_INPUT_PIXELS = 40_000_000; // 40MP — muy por encima de cualquier logo real

/** Los logos no necesitan más resolución que esto. */
 ...
 * logo fijo — esto normaliza el storage a un solo formato/tamaño y,
