...
describe('SharpImageProcessorService', () => {
  ...
  describe('sanitize', () => {
    ...
    it('debe reducir imágenes más grandes que el tamaño máximo de logo sin recortar (fit: contain)', async () => {
    ...
    it('debe rechazar un formato decodificable pero no soportado (ej. GIF)', async () => {
      ...
      await expect(service.sanitize(gif)).rejects.toThrow(/UNSUPPORTED_IMAGE_FORMAT/);
    });
