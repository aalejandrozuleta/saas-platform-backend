...
/**
 * Alerta de seguridad enviada cuando se desactiva la autenticación de dos
 * factores (2FA) en una cuenta (template `2fa-disabled` en
 * `TemplateEngine`) — desactivar 2FA reduce la protección de la cuenta, por
 * lo que se avisa explícitamente para detectar un cambio no autorizado.
 *
 * @param email - Cuenta afectada.
 * @param disabledAt - Fecha/hora en que se desactivó (texto ya formateado).
  ...
  return Base(
    ...
    e(
      ...
      e(
        'p',
        { style: s.body },
        'La verificación en dos pasos ha sido ',
        e('strong', { style: s.danger }, 'deshabilitada'),
        ' en tu cuenta Arlok.',
      ),
      e(
        'p',
        { style: s.body },
        'Si no realizaste este cambio, tu cuenta puede estar comprometida. Contacta a soporte de inmediato.',
      ),
      ...
      e(
        ...
        ` ${email}`,
        e('br'),
        e('strong', { style: s.label }, 'Desactivado el:'),
        ` ${disabledAt}`,
        e('br'),
