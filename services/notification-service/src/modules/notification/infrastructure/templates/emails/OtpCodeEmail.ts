...
/**
 * Email con el código de verificación (OTP) de un solo uso (template
 * `otp-code` en `TemplateEngine`), enviado para confirmar acciones
 * sensibles (login, cambios de configuración, etc.).
 *
 * @param code - Código OTP a mostrar (se recomienda no loguearlo en claro
 * fuera de este template).
 * @param expiresIn - Minutos de validez del código.
 */
  ...
  return Base(
    ...
    e(
      ...
      e(
        'p',
        { style: s.body },
        'Utiliza el siguiente código para completar tu acción. No lo compartas con nadie.',
      ),
