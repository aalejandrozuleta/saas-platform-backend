...
/**
 * Confirmación enviada cuando se activa la autenticación de dos factores
 * (2FA) en una cuenta (template `2fa-enabled` en `TemplateEngine`).
 *
 * @param email - Cuenta afectada.
 * @param enabledAt - Fecha/hora de activación (texto ya formateado).
  ...
  return Base(
    ...
    e(
      ...
      e(
        'p',
        { style: s.body },
        'La verificación en dos pasos ha sido habilitada en tu cuenta Arlok. Tu cuenta ahora cuenta con una capa adicional de protección.',
      ),
      e(
        'p',
        { style: s.body },
        'Cada vez que inicies sesión necesitarás tu código TOTP además de tu contraseña.',
      ),
      ...
      e(
        ...
        ` ${email}`,
        e('br'),
        e('strong', { style: s.label }, 'Activado el:'),
        ` ${enabledAt}`,
        e('br'),
